...
const recommendedWordData = [
  ['あんしん', '안신', '안심', 'anshin'], ['ふあん', '후안', '불안', 'fuan'], ['きぼう', '키보-', '희망', 'kibou'], ['ゆめ', '유메', '꿈', 'yume'],
  ['ねがい', '네가이', '소원', 'negai'], ['じしん', '지신', '자신', 'jishin'], ['ゆうき', '유-키', '용기', 'yuuki'], ['どりょく', '도료쿠', '노력', 'doryoku'],
  ['せいこう', '세-코-', '성공', 'seikou'], ['しっぱい', '십파이', '실패', 'shippai'], ['へいわ', '헤-와', '평화', 'heiwa'], ['あいじょう', '아이죠-', '애정', 'aijou'],
  ['かんどう', '칸도-', '감동', 'kandou'], ['きんちょう', '킨초-', '긴장', 'kinchou'], ['たいくつ', '타이쿠츠', '지루함', 'taikutsu'], ['まんぞく', '만조쿠', '만족', 'manzoku'],
  ['ふまん', '후만', '불만', 'fuman'], ['しんぱい', '신파이', '걱정', 'shinpai'], ['はんたい', '한타이', '반대', 'hantai'], ['さんせい', '산세-', '찬성', 'sansei'],
  ['いけん', '이켄', '의견', 'iken'], ['りゆう', '리유-', '이유', 'riyuu'], ['けっか', '켓카', '결과', 'kekka'], ['もくてき', '모쿠테키', '목적', 'mokuteki'],
  ['ばあい', '바아이', '경우', 'baai'], ['ほうほう', '호-호-', '방법', 'houhou'], ['ひつよう', '히츠요-', '필요', 'hitsuyou'], ['じゅうぶん', '주-분', '충분', 'juubun'],
  ['とくに', '토쿠니', '특히', 'tokuni'], ['さいきん', '사이킨', '최근', 'saikin'], ['たいてい', '타이테-', '대개', 'taitei'], ['ぜんぜん', '젠젠', '전혀', 'zenzen'],
  ['たとえば', '타토에바', '예를 들면', 'tatoeba'], ['もし', '모시', '만약', 'moshi'], ['もちろん', '모치론', '물론', 'mochiron'], ['たしかに', '타시카니', '확실히', 'tashikani'],
  ['なるほど', '나루호도', '과연', 'naruhodo'], ['けっこう', '켓코-', '꽤/괜찮음', 'kekkou'], ['ぜったい', '젯타이', '절대', 'zettai'], ['かならず', '카나라즈', '반드시', 'kanarazu'],
  ['たぶん', '타분', '아마', 'tabun'], ['ようやく', '요-야쿠', '드디어', 'youyaku'], ['さらに', '사라니', '더욱', 'sarani'], ['とつぜん', '토츠젠', '갑자기', 'totsuzen'],
  ['しばらく', '시바라쿠', '잠시', 'shibaraku'], ['あいだ', '아이다', '사이', 'aida'], ['さいしょ', '사이쇼', '처음', 'saisho'], ['さいご', '사이고', '마지막', 'saigo'],
  ['りょうほう', '료-호-', '양쪽', 'ryouhou'], ['さいきん', '사이킨', '최근', 'saikin'], ['きょうみ', '쿄-미', '흥미', 'kyoumi'], ['しゅうかん', '슈-칸', '습관', 'shuukan'],
  ['よてい', '요테-', '예정', 'yotei'], ['じゅんび', '준비', '준비', 'junbi'], ['せつめい', '세츠메-', '설명', 'setsumei'], ['れんらく', '렌라쿠', '연락', 'renraku'],
  ['そうだん', '소-단', '상담', 'soudan'], ['やくそく', '야쿠소쿠', '약속', 'yakusoku'], ['しょうかい', '쇼-카이', '소개', 'shoukai'], ['あいさつ', '아이사츠', '인사', 'aisatsu'],
  ['しつれい', '시츠레-', '실례', 'shitsurei'], ['おねがい', '오네가이', '부탁', 'onegai'], ['かんしゃ', '칸샤', '감사', 'kansha'], ['しんせつ', '신세츠', '친절', 'shinsetsu'],
  ['りょうかい', '료-카이', '알겠습니다', 'ryoukai'], ['だいじょうぶ', '다이죠-부', '괜찮다', 'daijoubu'], ['ざんねん', '잔넨', '유감', 'zannen'], ['たいへん', '타이헨', '힘듦/매우', 'taihen'],
  ['うれしい', '우레시-', '기쁘다', 'ureshii'], ['かなしい', '카나시-', '슬프다', 'kanashii'], ['はずかしい', '하즈카시-', '부끄럽다', 'hazukashii'], ['くやしい', '쿠야시-', '분하다', 'kuyashii'],
  ['おどろく', '오도로쿠', '놀라다', 'odoroku'], ['あきる', '아키루', '질리다', 'akiru'], ['あきらか', '아키라카', '명백함', 'akiraka'], ['こわい', '코와이', '무섭다', 'kowai'],
  ['ねむい', '네무이', '졸리다', 'nemui'], ['だるい', '다루이', '나른하다', 'darui'], ['いたい', '이타이', '아프다', 'itai'], ['かゆい', '카유이', '가렵다', 'kayui'],
  ['げんいん', '겐인', '원인', 'genin'], ['しょうじょう', '쇼-죠-', '증상', 'shoujou'], ['ちりょう', '치료-', '치료', 'chiryou'], ['しんさつ', '신사츠', '진찰', 'shinsatsu'],
  ['ほけん', '호켄', '보험', 'hoken'], ['きゅうきゅうしゃ', '큐-큐-샤', '구급차', 'kyuukyuusha'], ['たいおん', '타이온', '체온', 'taion'], ['けつあつ', '케츠아츠', '혈압', 'ketsuatsu'],
  ['しょくよく', '쇼쿠요쿠', '식욕', 'shokuyoku'], ['えいよう', '에-요-', '영양', 'eiyou'], ['うんどう', '운도-', '운동', 'undou'], ['さんぽ', '산포', '산책', 'sanpo'],
  ['りょこうしゃ', '료코-샤', '여행자', 'ryokousha'], ['かんこう', '칸코-', '관광', 'kankou'], ['あんない', '안나이', '안내', 'annai'], ['よやくせき', '요야쿠세키', '예약석', 'yoyakuseki'],
  ['にもつ', '니모츠', '짐', 'nimotsu'], ['りょけん', '료켄', '여권', 'ryoken'], ['びざ', '비자', '비자', 'biza'], ['しゅっぱつ', '슛파츠', '출발', 'shuppatsu'],
  ['とうちゃく', '토-차쿠', '도착', 'touchaku'], ['のりば', '노리바', '승강장', 'noriba'], ['かたみち', '카타미치', '편도', 'katamichi'], ['おうふく', '오-후쿠', '왕복', 'oufuku'],
  ['うんてんしゅ', '운텐슈', '운전기사', 'untenshu'], ['しんかんせん', '싱칸센', '신칸센', 'shinkansen'], ['じこくひょう', '지코쿠효-', '시간표', 'jikokuhyou'], ['ちえん', '치엔', '지연', 'chien'],
  ['うりば', '우리바', '매장', 'uriba'], ['しょうひん', '쇼-힌', '상품', 'shouhin'], ['しょうひぜい', '쇼-히제-', '소비세', 'shouhizei'], ['わりびき', '와리비키', '할인', 'waribiki'],
  ['ばーげん', '바-겐', '세일', 'baagen'], ['ざいこ', '자이코', '재고', 'zaiko'], ['しなもの', '시나모노', '물건', 'shinamono'], ['ひんしつ', '힌시츠', '품질', 'hinshitsu'],
  ['さいず', '사이즈', '사이즈', 'saizu'], ['しちゃく', '시차쿠', '시착/입어봄', 'shichaku'], ['こうかん', '코-칸', '교환', 'koukan'], ['へんぴん', '헨핀', '반품', 'henpin'],
  ...
  ['ちょうみりょう', '초-미료-', '조미료', 'choumiryou'], ['おかし', '오카시', '과자', 'okashi'], ['あいすくりーむ', '아이스쿠리-무', '아이스크림', 'aisukuriimu'], ['けーき', '케-키', '케이크', 'keeki'],
  ['ちょこれーと', '초코레-토', '초콜릿', 'chokoreeto'], ['びーる', '비-루', '맥주', 'biiru'], ['わいん', '와인', '와인', 'wain'], ['おさけ', '오사케', '술', 'osake'],
  ['えんかい', '엔카이', '회식/연회', 'enkai'], ['かんぱい', '칸파이', '건배', 'kanpai'], ['ちゅうもん', '츄-몬', '주문', 'chuumon'], ['おすすめ', '오스스메', '추천 메뉴', 'osusume'],
  ['やきにく', '야키니쿠', '고기구이', 'yakiniku'], ['てんぷら', '텐푸라', '튀김', 'tenpura'], ['おこのみやき', '오코노미야키', '오코노미야키', 'okonomiyaki'], ['ぎょうざ', '교-자', '교자', 'gyouza'],
  ['さしみ', '사시미', '회', 'sashimi'], ['どんぶり', '돈부리', '덮밥', 'donburi'], ['かれー', '카레-', '카레', 'karee'], ['おべんとう', '오벤토-', '도시락', 'obentou'],
  ['あつまる', '아츠마루', '모이다', 'atsumaru'], ['えらぶ', '에라부', '고르다', 'erabu'], ['くらべる', '쿠라베루', '비교하다', 'kuraberu'], ['さそう', '사소우', '권하다', 'sasou'],
  ['たずねる', '타즈네루', '방문하다/묻다', 'tazuneru'], ['たのしむ', '타노시무', '즐기다', 'tanoshimu'], ['つづく', '츠즈쿠', '계속되다', 'tsuzuku'], ['とどける', '토도케루', '전달하다', 'todokeru'],
  ['なおす', '나오스', '고치다', 'naosu'], ['はこぶ', '하코부', '나르다', 'hakobu'], ['ひろう', '히로우', '줍다', 'hirou'], ['ふえる', '후에루', '늘다', 'fueru'],
  ['へる', '헤루', '줄다', 'heru'], ['まにあう', '마니아우', '시간에 맞다', 'maniau'], ['もどす', '모도스', '되돌리다', 'modosu'], ['わかれる', '와카레루', '헤어지다', 'wakareru'],
  ['わらう', '와라우', '웃다', 'warau'], ['あやまる', '아야마루', '사과하다', 'ayamaru'], ['いそぐ', '이소구', '서두르다', 'isogu'], ['うごく', '우고쿠', '움직이다', 'ugoku'],
  ['おくれる', '오쿠레루', '늦다', 'okureru'], ['おもいだす', '오모이다스', '떠올리다', 'omoidasu'], ['かんじる', '칸지루', '느끼다', 'kanjiru'], ['きまる', '키마루', '정해지다', 'kimaru'],
  ['しらせる', '시라세루', '알리다', 'shiraseru'], ['すぎる', '스기루', '지나가다', 'sugiru'], ['そだてる', '소다테루', '기르다', 'sodateru'], ['たおれる', '타오레루', '쓰러지다', 'taoreru'],
  ['たしかめる', '타시카메루', '확인하다', 'tashikameru'], ['つく', '츠쿠', '도착하다', 'tsuku'], ['つれていく', '츠레테이쿠', '데리고 가다', 'tsureteiku'], ['てつだう', '테츠다우', '돕다', 'tetsudau'],
  ['とまる', '토마루', '묵다/멈추다', 'tomaru'], ['なおる', '나오루', '낫다/고쳐지다', 'naoru'], ['ぬぐ', '누구', '벗다', 'nugu'], ['はじめる', '하지메루', '시작하다', 'hajimeru'],
  ['ひらく', '히라쿠', '열다', 'hiraku'], ['ふく', '후쿠', '불다', 'fuku'], ['ふとる', '후토루', '살찌다', 'futoru'], ['へんじする', '헨지스루', '대답하다', 'henjisuru'],
  ['ほうこくする', '호-코쿠스루', '보고하다', 'houkokusuru'], ['まちがう', '마치가우', '틀리다', 'machigau'], ['みつかる', '미츠카루', '발견되다', 'mitsukaru'], ['もうしこむ', '모-시코무', '신청하다', 'moushikomu'],
  ['やくにたつ', '야쿠니다츠', '도움이 되다', 'yakunitatsu'], ['よごれる', '요고레루', '더러워지다', 'yogoreru'], ['よぶ', '요부', '부르다', 'yobu'], ['わすれもの', '와스레모노', '분실물', 'wasuremono'],
].map(([word, readingKo, meaningKo, romaji]) => ({ word, readingKo, meaningKo, romaji, category: 'recommended' }))

const recommendedWordCards = (() => {
  const usedWords = new Set([...wordCards, ...additionalDailyWords, ...additionalVerbCards, ...finalDailyWords].map((card) => card.word))

  return recommendedWordData.filter((card) => {
